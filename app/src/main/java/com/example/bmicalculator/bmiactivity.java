...
public class bmiactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        height=intent.getStringExtra("wysokosc");
        weight=intent.getStringExtra("waga");
        ...
        {
            mbmicategory.setText("Wychudzenie");
        ...
        {
            mbmicategory.setText("Niedowaga");
            mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.warning);
        }
        else if(intbmi<24.9 && intbmi>18.5 )
        {
            mbmicategory.setText("Waga prawidłowa");
        ...
        mgender.setText(intent.getStringExtra("plec"));
